...
export type UpdateUserDailyRecipeMutationVariables = Exact<{
...
export type UpdateUserDailyRecipeMutation = { __typename?: 'mutation_root', update_user_daily_recipes_by_pk?: { __typename?: 'user_daily_recipes', user_daily_recipes_id: string, user_daily_id: string, brunch_type: string, is_created: boolean, recipe_id: string } | null };
...
export type CreateRecipeMaterialsMutation = { __typename?: 'mutation_root', insert_recipe_materials?: { __typename?: 'recipe_materials_mutation_response', returning: Array<{ __typename?: 'recipe_materials', recipe_material_id: string, master_id: string, quantity: number, recipe_id: string }> } | null };
...
export type CreateRecipeStepsMutation = { __typename?: 'mutation_root', insert_recipe_steps?: { __typename?: 'recipe_steps_mutation_response', returning: Array<{ __typename?: 'recipe_steps', recipe_step_id: string, recipe_id: string, description: string }> } | null };
...
export const UpdateUserDailyRecipeDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"UpdateUserDailyRecipe"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"userDailyRecipeId"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"uuid"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"brunchType"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"isCreated"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"Boolean"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"recipeId"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"uuid"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"update_user_daily_recipes_by_pk"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"pk_columns"},"value":{"kind":"ObjectValue","fields":[{"kind":"ObjectField","name":{"kind":"Name","value":"user_daily_recipes_id"},"value":{"kind":"Variable","name":{"kind":"Name","value":"userDailyRecipeId"}}}]}},{"kind":"Argument","name":{"kind":"Name","value":"_set"},"value":{"kind":"ObjectValue","fields":[{"kind":"ObjectField","name":{"kind":"Name","value":"brunch_type"},"value":{"kind":"Variable","name":{"kind":"Name","value":"brunchType"}}},{"kind":"ObjectField","name":{"kind":"Name","value":"is_created"},"value":{"kind":"Variable","name":{"kind":"Name","value":"isCreated"}}},{"kind":"ObjectField","name":{"kind":"Name","value":"recipe_id"},"value":{"kind":"Variable","name":{"kind":"Name","value":"recipeId"}}}]}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"user_daily_recipes_id"}},{"kind":"Field","name":{"kind":"Name","value":"user_daily_id"}},{"kind":"Field","name":{"kind":"Name","value":"brunch_type"}},{"kind":"Field","name":{"kind":"Name","value":"is_created"}},{"kind":"Field","name":{"kind":"Name","value":"recipe_id"}}]}}]}}]} as unknown as DocumentNode<UpdateUserDailyRecipeMutation, UpdateUserDailyRecipeMutationVariables>;
