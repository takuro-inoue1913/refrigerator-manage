...
export const generateProteinSourceStocks = (
  ...
  const ids: string[] = [];
  const proteinSourceMasterData = convertProteinSourceMasterData(
    'proteinSourceMaster',
  ...
  ids.push(...Object.keys(proteinSourceMasterData).map((id) => id));
...
const convertProteinSourceMasterData = (
  __typename: 'proteinSourceMaster' | 'customProteinSourceMaster',
  masterData:
