...
import { useRequestGetOtherStocks } from '@src/interface/hooks/other/useRequestGetOtherStocks';
...
import { useRequestUpsertOtherStock } from '@src/interface/hooks/other/useRequestUpsertOtherStock';
...
import { useRequestUpsertOtherStockDetail } from '@src/interface/hooks/other/useRequestUpsertOtherStockDetail';
import { GestureHandlerView } from '../GestureHandlerView';
import { ItemDisplayContents } from '../ItemDisplayContents';
import { useRequestUpsertOtherFavorite } from '@src/interface/hooks/other/useRequestUpsertOtherFavorite';
